...
public interface ElementService {
    ...
    List<ElementResponseDTO> getElementWithModuleAndProf(Long idProf, Long idModule, String libelSemestre, String libelS)  ;

    List<ElementResponseDTO> getElementWithModuleAndProf(Long idProf, Long idModule, String libelS);
}
