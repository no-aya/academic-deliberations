...
import ma.enset.jwt.services.AccountService;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        return  http.csrf(csrf->csrf.disable())
                ...
                .authorizeRequests(auth -> auth.requestMatchers("/h2-console/**").permitAll() )
                .authorizeRequests(auth -> auth.requestMatchers("/idToken/**","/token/**").permitAll() )
